...
import { getGenreTopFilms } from "@/lib/data/index-queries";
...
export async function GET(
  ...
  try {
    ...
    const rows = await getGenreTopFilms(genreSlug, limit ?? 25);
    ...
    return jsonError(error instanceof Error ? error.message : "Failed to fetch genre films", 500);
  }
}
